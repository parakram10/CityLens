...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="Write a partial detections.json of confirmed-so-far issues every N seconds "
        "during processing, so a dashboard can watch de-duplicated issues accumulate live.",
    )
    return parser
